...
export default function TickerSlider() {
    ...
    return (
        <div className="relative w-full bg-[#f8fafc] overflow-hidden py-10 flex justify-center">
            <div className="relative w-full bg-white py-5 -rotate-1 transform origin-center shadow-xs flex justify-center">
                ...
                <div className="w-full max-w-6xl overflow-hidden">
                    ...
                    >
                        {sliderItems.map((item, index) => (
                            ...
                            >
                                <span className="text-xl lg:text-[25px] font-bold text-[#334155] tracking-tight select-none">
                                    {item}
                                </span>
                            </div>
                        ))}
